...
# (never the real test set), against the GRAPH-ENCODER base model. Same
# clip-vs-worst-case tradeoff pattern as the plain-MLP pipeline: weighted
# mean improvement keeps climbing as the clip loosens (up to +3.04m fully
# unclipped), but so does one pair's worst-case regression (-0.07m at 0.15
# growing to -2.19m at 0.6). Chose 0.25: weighted mean +1.33m with the
# worst case still mild (-0.33m).
GATE_THRESHOLD = None
MAX_DELTA_FRAC = 0.25
