...
def load_frozen_base(out_dir=OUT_DIR):
    """SOD-HCXY is single-floor, so no floor classifier is needed here --
    just load the plain frozen BaseMLP (unlike the UJIIndoorLoc variant,
    which wraps a floor classifier + localization MLP together)."""
